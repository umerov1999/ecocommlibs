...
set(Qt5WebEngine_VERSION_STRING 5.5.0)
...
if (NOT TARGET Qt5::WebEngine)
    ...
    set(Qt5WebEngine_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngine_install_prefix}/include/QtWebEngine/5.5.0"
        "${_qt5WebEngine_install_prefix}/include/QtWebEngine/5.5.0/QtWebEngine"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngine_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.5.0 ${_Qt5WebEngine_FIND_VERSION_EXACT}
