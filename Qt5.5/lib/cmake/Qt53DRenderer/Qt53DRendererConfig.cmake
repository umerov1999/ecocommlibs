...
set(Qt53DRenderer_VERSION_STRING 5.5.0)
...
if (NOT TARGET Qt5::3DRenderer)
    ...
    set(Qt53DRenderer_PRIVATE_INCLUDE_DIRS
        "${_qt53DRenderer_install_prefix}/include/Qt3DRenderer/5.5.0"
        "${_qt53DRenderer_install_prefix}/include/Qt3DRenderer/5.5.0/Qt3DRenderer"
    )
    ...
    set(_Qt53DRenderer_MODULE_DEPENDENCIES "3DCore;OpenGLExtensions;Gui;Core")
    ...
    foreach(_module_dep ${_Qt53DRenderer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.5.0 ${_Qt53DRenderer_FIND_VERSION_EXACT}
    ...
    set(_Qt53DRenderer_LIB_DEPENDENCIES "Qt5::3DCore;Qt5::OpenGLExtensions;Qt5::Gui;Qt5::Core")
