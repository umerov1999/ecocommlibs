...
set(Qt5Enginio_VERSION_STRING 1.2.0)
...
if (NOT TARGET Qt5::Enginio)
    ...
    set(Qt5Enginio_PRIVATE_INCLUDE_DIRS
        "${_qt5Enginio_install_prefix}/include/Enginio/1.2.0"
        "${_qt5Enginio_install_prefix}/include/Enginio/1.2.0/Enginio"
    )
    ...
    foreach(_module_dep ${_Qt5Enginio_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                1.2.0 ${_Qt5Enginio_FIND_VERSION_EXACT}
