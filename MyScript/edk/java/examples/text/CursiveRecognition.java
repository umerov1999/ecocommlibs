...
/**
 * The <code>CursiveRecognition</code> example code shows you how to
 * perform handwriting recognition on cursive digital ink.
 */
public class CursiveRecognition
{
  /**
   * Main entry point for the <code>CursiveRecognition</code> example
   * program.
   */
  public static final void main(String[] args) throws IOException
  {
    ...
    {
      args = new String[1];
      args[0] = CFG.DATA_DIR + "/hello_world_cursive.ink";
    }
    ...
    System.out.println(" you just learnt how to perform handwriting recognition on cursive digital ink");
  }
