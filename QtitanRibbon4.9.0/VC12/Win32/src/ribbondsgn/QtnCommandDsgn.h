...
namespace Qtitan
{
    ...
    public:
        void init(RibbonPage* ribbonPage, RibbonGroup* group);
        virtual void undo();
        virtual void redo();
    private:
    ...
    /* AddRibbonGroupCommand */
    class DeleteRibbonGroupCommand : public FormDsgnCommand
    {
    public:
        explicit DeleteRibbonGroupCommand(QDesignerFormWindowInterface* formWindow);
        virtual ~DeleteRibbonGroupCommand();
    public:
        void init(RibbonPage* ribbonPage, RibbonGroup* ribbonGroup);
        virtual void undo();
        virtual void redo();
    private:
        RibbonPage* m_ribbonPage;
