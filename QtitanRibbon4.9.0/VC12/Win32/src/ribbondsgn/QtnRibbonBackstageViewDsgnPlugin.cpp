...
{
    return create_qtitan_className("RibbonBackstageSeparator");
}
...
QString RibbonBackstageSeparatorPlugin::domXml() const
{
    return "<ui language=\"c++\">\n"
        " <widget class=\"" + create_qtitan_className("RibbonBackstageSeparator") + "\" name=\"backstageSeparator\">\n"
...
{
    return create_qtitan_className("RibbonBackstageButton");
}
...
{
    return "<ui language=\"c++\">\n"
        " <widget class=\"" + create_qtitan_className("RibbonBackstageButton") + "\" name=\"backstageButton\">\n"
        "  <property name=\"geometry\">\n"
        "   <rect>\n"
        "    <width>100</width>\n"
        "    <height>100</height>\n"
...
{
    return create_qtitan_className("RibbonBackstagePage");
}
