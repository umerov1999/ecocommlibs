...
BEGIN_DISPATCH_MAP(CXTPReportRecordItem, CCmdTarget)
...
// {45989CE5-E015-4f87-885D-DE3326A63BEA}
static const GUID IID_IReportRecordItem =
{ 0x45989ce5, 0xe015, 0x4f87, { 0x88, 0x5d, 0xde, 0x33, 0x26, 0xa6, 0x3b, 0xea } };

BEGIN_INTERFACE_MAP(CXTPReportRecordItem, CCmdTarget)
	INTERFACE_PART(CXTPReportRecordItem, IID_IReportRecordItem, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPReportRecordItem, IID_IReportRecordItem)
...
BEGIN_DISPATCH_MAP(XTP_REPORTRECORDITEM_METRICS, CCmdTarget)
...
// {15989CE5-E015-4f87-885D-DE3326A63BEA}
static const GUID IID_IReportRecordItemMetrics =
{ 0x15989ce5, 0xe015, 0x4f87, { 0x88, 0x5d, 0xde, 0x33, 0x26, 0xa6, 0x3b, 0xea } };

BEGIN_INTERFACE_MAP(XTP_REPORTRECORDITEM_METRICS, CCmdTarget)
	INTERFACE_PART(XTP_REPORTRECORDITEM_METRICS, IID_IReportRecordItemMetrics, Dispatch)
END_INTERFACE_MAP()


LPFONTDISP XTP_REPORTRECORDITEM_METRICS::OleGetFont()
{
	return AxCreateOleFont(m_fntMetrics.GetSafeHandle() ? &m_fntMetrics : pFont, this, (LPFNFONTCHANGED)&XTP_REPORTRECORDITEM_METRICS::OleSetFont);
}

void XTP_REPORTRECORDITEM_METRICS::OleSetFont(LPFONTDISP pFontDisp)
{
	if (AxCreateFontFromDispatch(&m_fntMetrics, pFontDisp))
	{
		pFont = &m_fntMetrics;
	}
}
