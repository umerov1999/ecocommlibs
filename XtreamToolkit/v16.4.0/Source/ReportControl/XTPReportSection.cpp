...
int CXTPReportSection::_DoExpand(int nIndex, CXTPReportRow *pRow)
{
	...
	if (nCount > 0)
	{
		GetSelectedRows()->_OnExpanded(nIndex, nCount);
	}
...
// {4D0EC16F-7DFC-4ab3-88CD-F592304CF659}
static const GUID IID_IReportSection =
{ 0x4d0ec16f, 0x7dfc, 0x4ab3, { 0x88, 0xcd, 0xf5, 0x92, 0x30, 0x4c, 0xf6, 0x59 } };

IMPLEMENT_OLETYPELIB_EX(CXTPReportSection, IID_IReportSection)
...
BEGIN_INTERFACE_MAP(CXTPReportSection, CXTPCmdTarget)
	INTERFACE_PART(CXTPReportSection, IID_IReportSection, Dispatch)
END_INTERFACE_MAP()
