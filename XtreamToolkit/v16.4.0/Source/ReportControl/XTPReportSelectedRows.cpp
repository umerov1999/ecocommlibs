...
BEGIN_DISPATCH_MAP(CXTPReportSelectedRows, CCmdTarget)
...
// {D87BCC77-27BF-4cb1-9ABF-1788D9835113}
static const GUID IID_IReportSelectedRows =
{ 0xD87bcc77, 0x27bf, 0x4cb1, { 0x9a, 0xbf, 0x17, 0x88, 0xd9, 0x83, 0x51, 0x13 } };

BEGIN_INTERFACE_MAP(CXTPReportSelectedRows, CCmdTarget)
	INTERFACE_PART(CXTPReportSelectedRows, IID_IReportSelectedRows, Dispatch)
	//INTERFACE_PART(CXTPReportSelectedRows, IID_IEnumVARIANT, EnumVARIANT)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPReportSelectedRows, IID_IReportSelectedRows)
