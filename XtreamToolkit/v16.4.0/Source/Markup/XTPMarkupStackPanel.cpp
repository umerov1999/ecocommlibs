...
// {10089842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IMarkupStackPanel =
{ 0x10089842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


BEGIN_INTERFACE_MAP(CXTPMarkupStackPanel, CXTPMarkupPanel)
	INTERFACE_PART(CXTPMarkupStackPanel, IID_IMarkupStackPanel, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupStackPanel, IID_IMarkupStackPanel)
...
// {10099842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IMarkupDockPanel =
{ 0x10099842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


BEGIN_INTERFACE_MAP(CXTPMarkupDockPanel, CXTPMarkupPanel)
	INTERFACE_PART(CXTPMarkupDockPanel, IID_IMarkupDockPanel, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupDockPanel, IID_IMarkupDockPanel)
...
// {10109842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IMarkupWrapPanel =
{ 0x10109842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


BEGIN_INTERFACE_MAP(CXTPMarkupWrapPanel, CXTPMarkupPanel)
	INTERFACE_PART(CXTPMarkupWrapPanel, IID_IMarkupWrapPanel, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupWrapPanel, IID_IMarkupWrapPanel)
...
// {10529842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IMarkupUniformGrid =
{ 0x10529842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


BEGIN_INTERFACE_MAP(CXTPMarkupUniformGrid, CXTPMarkupPanel)
INTERFACE_PART(CXTPMarkupUniformGrid, IID_IMarkupUniformGrid, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupUniformGrid, IID_IMarkupUniformGrid)
