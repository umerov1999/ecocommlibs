...
CXTPMarkupString* CXTPMarkupString::CreateValue(LPCWSTR lpszString, int nLength)
{
	...
	{
		static CXTPMarkupAutoPtr stringEmpty(new CXTPMarkupString(L"", 0));
...
BEGIN_DISPATCH_MAP(CXTPMarkupObject, CCmdTarget)
END_DISPATCH_MAP()

// {10009842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IMarkupObject =
{ 0x10009842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


BEGIN_INTERFACE_MAP(CXTPMarkupObject, CCmdTarget)
	INTERFACE_PART(CXTPMarkupObject, IID_IMarkupObject, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupObject, IID_IMarkupObject)
...
CXTPMarkupObject* CXTPMarkupObject::FromDispatch(LPDISPATCH lpElementDisp, BOOL bAddRef)
{
	...
	if (bAddRef) lpElementDisp->AddRef();
	return (CXTPMarkupObject*)CCmdTarget::FromIDispatch(lpElementDisp);
}
...
// {20119842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IMarkupDoubleCollection =
{ 0x20119842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


BEGIN_INTERFACE_MAP(CXTPMarkupDoubleCollection, CXTPMarkupObject)
	INTERFACE_PART(CXTPMarkupDoubleCollection, IID_IMarkupDoubleCollection, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupDoubleCollection, IID_IMarkupDoubleCollection)
