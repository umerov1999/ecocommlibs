...
// {10469842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IMarkupButtonBase =
{ 0x10469842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


BEGIN_INTERFACE_MAP(CXTPMarkupButtonBase, CXTPMarkupFrameworkElement)
	INTERFACE_PART(CXTPMarkupButtonBase, IID_IMarkupButtonBase, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupButtonBase, IID_IMarkupButtonBase)
...
// {10479842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IMarkupButton =
{ 0x10479842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


BEGIN_INTERFACE_MAP(CXTPMarkupButton, CXTPMarkupButtonBase)
	INTERFACE_PART(CXTPMarkupButton, IID_IMarkupButton, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupButton, IID_IMarkupButton)
...
// {10489842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IMarkupToggleButton =
{ 0x10489842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


BEGIN_INTERFACE_MAP(CXTPMarkupToggleButton, CXTPMarkupButtonBase)
	INTERFACE_PART(CXTPMarkupToggleButton, IID_IMarkupToggleButton, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupToggleButton, IID_IMarkupToggleButton)
...
// {10499842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IMarkupRadioButton =
{ 0x10499842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


BEGIN_INTERFACE_MAP(CXTPMarkupRadioButton, CXTPMarkupToggleButton)
	INTERFACE_PART(CXTPMarkupRadioButton, IID_IMarkupRadioButton, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupRadioButton, IID_IMarkupRadioButton)
...
// {10509842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IMarkupCheckBox =
{ 0x10509842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


BEGIN_INTERFACE_MAP(CXTPMarkupCheckBox, CXTPMarkupToggleButton)
	INTERFACE_PART(CXTPMarkupCheckBox, IID_IMarkupCheckBox, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupCheckBox, IID_IMarkupCheckBox)
