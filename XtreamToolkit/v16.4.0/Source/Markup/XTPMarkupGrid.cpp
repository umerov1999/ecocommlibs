...
// {10049842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IMarkupGrid =
{ 0x10049842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


BEGIN_INTERFACE_MAP(CXTPMarkupGrid, CXTPMarkupPanel)
	INTERFACE_PART(CXTPMarkupGrid, IID_IMarkupGrid, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupGrid, IID_IMarkupGrid)
