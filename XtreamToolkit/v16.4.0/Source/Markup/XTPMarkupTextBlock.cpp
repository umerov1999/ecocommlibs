...
// {10129842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IMarkupTextBlock =
{ 0x10129842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


BEGIN_INTERFACE_MAP(CXTPMarkupTextBlock, CXTPMarkupFrameworkElement)
	INTERFACE_PART(CXTPMarkupTextBlock, IID_IMarkupTextBlock, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupTextBlock, IID_IMarkupTextBlock)
