...
void CXTPSpinButtonCtrl::DrawArrowGlyph2(CDC* pDC, CRect rcArrow, BOOL bHorz, BOOL bUpArrow, BOOL bEnabled)
{
	...
	COLORREF clr = bEnabled ? m_crArrowEnabled : m_crArrowDisabled;
...
CRect CXTPSpinButtonCtrl::GetButtonRect(int nButton)
{
	...
	BOOL bOverride = (m_nTheme == xtpControlThemeUltraFlat
...
void CXTPSpinButtonCtrl::RefreshMetrics()
{
	...
	m_crArrowEnabled = RGB(0, 0, 0);
	m_crArrowDisabled = GetSysColor(COLOR_3DSHADOW);
	...
	case xtpControlThemeVisualStudio2012Light:
		m_crBack = RGB(246, 246, 246);
		m_crBackPushed = RGB(0, 122, 204);
		m_crBackHilite = RGB(0xfe, 0xfe, 0xfe);
		m_crBorder = m_crBorderHilite = RGB(219, 221, 230);
		break;
	case xtpControlThemeVisualStudio2012Dark:
		m_crBack = RGB(37, 37, 38);
		m_crBackPushed = RGB(0, 122, 204);
		m_crBackHilite = RGB(62, 62, 64);
		m_crBorder = m_crBorderHilite = RGB(219, 221, 230);
		m_crArrowEnabled = m_crBorder;
		m_crArrowDisabled = GetSysColor(COLOR_GRAYTEXT);
		break;
	default:
		m_crBackHilite = m_crBackPushed = m_crBack = GetXtremeColor(COLOR_3DFACE);
