...
// {BFEAAADD-4EF1-4ea0-9C0C-F2FF6518A00E}
static const GUID IID_ISyntaxEditDataManager =
{ 0xbfeaaadd, 0x4ef1, 0x4ea0, { 0x9c, 0xc, 0xf2, 0xff, 0x65, 0x18, 0xa0, 0xe } };

BEGIN_INTERFACE_MAP(CXTPSyntaxEditBufferManager, CCmdTarget)
	INTERFACE_PART(CXTPSyntaxEditBufferManager, IID_ISyntaxEditDataManager, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPSyntaxEditBufferManager, IID_ISyntaxEditDataManager)

BEGIN_DISPATCH_MAP(CXTPSyntaxEditBufferManager, CCmdTarget)
