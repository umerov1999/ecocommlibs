...
#include <TaskPanel/Themes/XTPTaskPanelToolboxWhidbeyTheme.h>
...
void CXTPTaskPanel::SetTheme(XTPTaskPanelPaintTheme theme)
{
	...
	case xtpTaskPanelThemeToolbox:
		pPaintManager = new CXTPTaskPanelToolboxTheme();
		break;

	case xtpTaskPanelThemeToolboxWhidbey:
		pPaintManager = new CXTPTaskPanelToolboxWhidbeyTheme();
