...
BEGIN_DISPATCH_MAP(CXTPDockingPaneSplitterContainer, CCmdTarget)
...
IMPLEMENT_OLETYPELIB_EX(CXTPDockingPaneSplitterContainer, IID_IDockingPaneContainer)


BEGIN_INTERFACE_MAP(CXTPDockingPaneSplitterContainer, CCmdTarget)
	INTERFACE_PART(CXTPDockingPaneSplitterContainer, IID_IDockingPaneContainer, Dispatch)
END_INTERFACE_MAP()
