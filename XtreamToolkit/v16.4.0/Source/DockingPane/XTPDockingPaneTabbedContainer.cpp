...
BEGIN_DISPATCH_MAP(CXTPDockingPaneTabbedContainer, CCmdTarget)
...
IMPLEMENT_OLETYPELIB_EX(CXTPDockingPaneTabbedContainer, IID_IDockingPaneContainer)
...
#ifdef _XTP_ACTIVEX
	INTERFACE_PART(CXTPDockingPaneTabbedContainer, IID_IDockingPaneContainer, Dispatch)
#endif
END_INTERFACE_MAP()
