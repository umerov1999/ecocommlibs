...
BEGIN_DISPATCH_MAP(CXTPDockingPaneSidePanel, CCmdTarget)
...
IMPLEMENT_OLETYPELIB_EX(CXTPDockingPaneSidePanel, IID_IDockingPaneContainer)


BEGIN_INTERFACE_MAP(CXTPDockingPaneSidePanel, CCmdTarget)
	INTERFACE_PART(CXTPDockingPaneSidePanel, IID_IDockingPaneContainer, Dispatch)
END_INTERFACE_MAP()
