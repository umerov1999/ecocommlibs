...
BEGIN_DISPATCH_MAP(CXTPDockingPaneMiniWnd, CCmdTarget)
...
IMPLEMENT_OLETYPELIB_EX(CXTPDockingPaneMiniWnd, IID_IDockingPaneContainer)

BEGIN_INTERFACE_MAP(CXTPDockingPaneMiniWnd, CCmdTarget)
	INTERFACE_PART(CXTPDockingPaneMiniWnd, IID_IDockingPaneContainer, Dispatch)
END_INTERFACE_MAP()
