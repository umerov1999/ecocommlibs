...
void CXTPRibbonTheme::UpdateFonts()
{
	...
	lf.lfHeight = nBaseHeight * 120 / XTP_DEFAULT_DISPLAY_DPI;
	...
	m_nTextHeight = CalcTextHeight(nBaseHeight, XTP_COMMANDBAR_CONTROL_HEIGHT_FACTOR, XTP_DEFAULT_DISPLAY_DPI);
	m_nEditHeight = m_nTextHeight;
	m_nSplitButtonDropDownWidth = CalcSplitButtonDropDownWidth(m_nTextHeight);
	m_nSplitButtonDropDownHeight = CalcSplitButtonDropDownHeight(nBaseHeight);
