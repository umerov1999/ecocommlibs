...
void CXTPTabClientWnd::CheckCommandBarsTheme()
{
	...
	m_pPaintManager->m_rcClientMargin.SetRect(2,2,2,2);
	...
	switch (themeCommandBars)
	{
		...
		case xtpThemeRibbon:
		{
			...
			m_pPaintManager->m_bOneNoteColors = FALSE;
			m_pPaintManager->m_bHotTracking = TRUE;
			m_pPaintManager->m_rcClientMargin.SetRect(3,2,3,4);
...
BEGIN_DISPATCH_MAP(CXTPTabClientWnd, CCmdTarget)
...
BEGIN_INTERFACE_MAP(CXTPTabClientWnd, CCmdTarget)
	INTERFACE_PART(CXTPTabClientWnd, IID_ITabWorkspace, Dispatch)
...
IMPLEMENT_OLETYPELIB_EX(CXTPTabClientWnd, IID_ITabWorkspace)


// {180A7B16-7BE8-42ec-870C-8849F5540F14}
static const GUID IID_ITabWorkspaceEvents =
{ 0x180a7b16, 0x7be8, 0x42ec, { 0x87, 0xc, 0x88, 0x49, 0xf5, 0x54, 0xf, 0x14 } };


IMPLEMENT_CONNECTION_EX(CXTPTabClientWnd, IID_ITabWorkspaceEvents)
...
{
	CXTPTabManagerItem* pItem = DYNAMIC_DOWNCAST(CXTPTabManagerItem, CXTPTabManagerItem::FromIDispatch(Item));
	if (!pItem)
		return -1;
