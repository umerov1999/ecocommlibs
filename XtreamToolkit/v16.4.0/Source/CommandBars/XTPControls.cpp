...
BEGIN_DISPATCH_MAP(CXTPControlActions, CCmdTarget)
...
// {DE7BCC77-27BF-4cb1-9ABF-1788D9835223}
static const GUID IID_ICommandBarActions =
{ 0xde7bcc77, 0x27bf, 0x4cb1, { 0x9a, 0xbf, 0x17, 0x88, 0xd9, 0x83, 0x52, 0x23 } };

BEGIN_INTERFACE_MAP(CXTPControlActions, CCmdTarget)
	INTERFACE_PART(CXTPControlActions, IID_ICommandBarActions, Dispatch)
//  //INTERFACE_PART(CXTPControlActions, IID_IEnumVARIANT, EnumVARIANT)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPControlActions, IID_ICommandBarActions)
...
BEGIN_DISPATCH_MAP(CXTPControls, CCmdTarget)
...
// {D87BCC77-27BF-4cb1-9ABF-1788D9835223}
static const GUID IID_ICommandBarControls =
{ 0xd87bcc77, 0x27bf, 0x4cb1, { 0x9a, 0xbf, 0x17, 0x88, 0xd9, 0x83, 0x52, 0x23 } };

BEGIN_INTERFACE_MAP(CXTPControls, CCmdTarget)
	INTERFACE_PART(CXTPControls, IID_ICommandBarControls, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPControls, IID_ICommandBarControls)
