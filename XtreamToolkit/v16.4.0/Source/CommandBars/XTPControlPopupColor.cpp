...
INT_PTR CXTPControlColorSelector::OnToolHitTest(CPoint point, TOOLINFO* pTI) const
{
	...
	INT_PTR nHit = gExtendedColors[nIndex].toolTipID;
...
// {A4568A35-789A-40d9-B564-7577DA549319}
static const GUID IID_ICommandBarPopupColor =
{ 0xa4568a35, 0x789a, 0x40d9, { 0xb5, 0x64, 0x75, 0x77, 0xda, 0x54, 0x93, 0x19 } };

BEGIN_INTERFACE_MAP(CXTPControlPopupColor, CXTPControlPopup)
	INTERFACE_PART(CXTPControlPopupColor, IID_ICommandBarPopupColor, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPControlPopupColor, IID_ICommandBarPopupColor)
...
// {B4568A35-789A-40d9-B564-7577DA549319}
static const GUID IID_ICommandBarControlColorSelector =
{ 0xb4568a35, 0x789a, 0x40d9, { 0xb5, 0x64, 0x75, 0x77, 0xda, 0x54, 0x93, 0x19 } };

BEGIN_INTERFACE_MAP(CXTPControlColorSelector, CXTPControl)
	INTERFACE_PART(CXTPControlColorSelector, IID_ICommandBarControlColorSelector, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPControlColorSelector, IID_ICommandBarControlColorSelector)
