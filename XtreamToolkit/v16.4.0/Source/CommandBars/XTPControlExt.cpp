...
void CXTPControlBitmap::Draw(CDC* pDC)
{
	...
	if (pIcon)
	{
		pIcon->Draw(pDC, GetRect().TopLeft());
	}
}
...
// {FA3F389C-1A6F-478c-8C8D-38C067A2BC1F}
static const GUID IID_ICommandBarCheckBox =
{ 0xfa3f389c, 0x1a6f, 0x478c, { 0x8c, 0x8d, 0x38, 0xc0, 0x67, 0xa2, 0xbc, 0x1f } };

BEGIN_INTERFACE_MAP(CXTPControlCheckBox, CXTPControlButton)
	INTERFACE_PART(CXTPControlCheckBox, IID_ICommandBarCheckBox, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPControlCheckBox, IID_ICommandBarCheckBox)
