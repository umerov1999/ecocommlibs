...
BEGIN_DISPATCH_MAP(CXTPColorManager, CCmdTarget)
	...
	DISP_PROPERTY_NOTIFY_ID(CXTPColorManager, "SystemTheme", 3, m_systemTheme, RefreshColors, VT_I4)
	DISP_PROPERTY_NOTIFY_ID(CXTPColorManager, "EnableLunaBlueForRoyaleTheme", 4, m_bEnableLunaBlueForRoyaleTheme, RefreshColors, VT_BOOL)
END_DISPATCH_MAP()

// {63C40CBE-DE43-4b56-BCEB-E14B825CF245}
static const GUID IID_IColorManager =
{ 0x63c40cbe, 0xde43, 0x4b56, { 0xbc, 0xeb, 0xe1, 0x4b, 0x82, 0x5c, 0xf2, 0x45 } };


BEGIN_INTERFACE_MAP(CXTPColorManager, CCmdTarget)
	INTERFACE_PART(CXTPColorManager, IID_IColorManager, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPColorManager, IID_IColorManager)
