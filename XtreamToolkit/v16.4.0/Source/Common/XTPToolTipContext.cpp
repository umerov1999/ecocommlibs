...
LRESULT CXTPToolTipContextToolTip::OnPrintClient(WPARAM wParam, LPARAM /*lParam*/)
{
	...
	CXTPFontDC font(pDC, &m_pContext->m_fnt);
...
void CXTPToolTipContext::SetStyle(XTPToolTipStyle toolStyle)
{
	if (m_toolStyle != toolStyle && (toolStyle != xtpToolTipBalloon || IsBalloonStyleSupported()))
	{
		...
		ModifyToolTipStyle(XTP_TTS_OFFICE2013FRAME, m_toolStyle == xtpToolTipOffice2013 ? XTP_TTS_OFFICE2013FRAME : 0);
	}
}
...
BEGIN_DISPATCH_MAP(CXTPToolTipContext, CCmdTarget)
...
// {ABBB9842-AE6D-46a8-BC77-CEE7D5CE9ED7}
static const GUID IID_IToolTipContext =
{ 0xabbb9842, 0xae6d, 0x46a8, { 0xbc, 0x77, 0xce, 0xe7, 0xd5, 0xce, 0x9e, 0xd7 } };


IMPLEMENT_OLETYPELIB_EX(CXTPToolTipContext, IID_IToolTipContext)

BEGIN_INTERFACE_MAP(CXTPToolTipContext, CCmdTarget)
	INTERFACE_PART(CXTPToolTipContext, IID_IToolTipContext, Dispatch)
END_INTERFACE_MAP()
...
{
	return AxCreateOleFont(&m_fnt, this, (LPFNFONTCHANGED)&CXTPToolTipContext::OleSetFont);
}
