...
BEGIN_DISPATCH_MAP(CXTPCalendarReminder, CCmdTarget)
...
// {45D1638C-3036-4c8c-9F49-E1BCA9E5DB14}
static const GUID IID_ICalendarReminder =
{ 0x45d1638c, 0x3036, 0x4c8c, { 0x9f, 0x49, 0xe1, 0xbc, 0xa9, 0xe5, 0xdb, 0x14 } };

BEGIN_INTERFACE_MAP(CXTPCalendarReminder, CCmdTarget)
	INTERFACE_PART(CXTPCalendarReminder, IID_ICalendarReminder, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPCalendarReminder, IID_ICalendarReminder)
...
//===========================================================================
BEGIN_DISPATCH_MAP(CXTPCalendarRemindersManager, CCmdTarget)
...
// {232FA57B-BACB-441a-9D37-E1B089FB040C}
static const GUID IID_ICalendarReminders =
{ 0x232fa57b, 0xbacb, 0x441a, { 0x9d, 0x37, 0xe1, 0xb0, 0x89, 0xfb, 0x4, 0xc } };


BEGIN_INTERFACE_MAP(CXTPCalendarRemindersManager, CCmdTarget)
	INTERFACE_PART(CXTPCalendarRemindersManager, IID_ICalendarReminders, Dispatch)
	//INTERFACE_PART(CXTPCalendarRemindersManager, IID_IEnumVARIANT, EnumVARIANT)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPCalendarRemindersManager, IID_ICalendarReminders)
