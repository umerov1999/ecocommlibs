...
class CXTPCalendarViewSelection : public CCmdTarget
{
public:
...
BEGIN_DISPATCH_MAP(CXTPCalendarViewSelection, CCmdTarget)
...
// {A9173695-CFC8-4ea9-8E6E-FFC19A437A44}
static const GUID IID_ICalendarViewSelection =
{ 0xa9173695, 0xcfc8, 0x4ea9, { 0x8e, 0x6e, 0xff, 0xc1, 0x9a, 0x43, 0x7a, 0x44 } };

BEGIN_INTERFACE_MAP(CXTPCalendarViewSelection, CCmdTarget)
	INTERFACE_PART(CXTPCalendarViewSelection, IID_ICalendarViewSelection, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPCalendarViewSelection, IID_ICalendarViewSelection)


//{{AFX_CODEJOCK_PRIVATE
class CXTPCalendarHitTestInfo : public CCmdTarget, public XTP_CALENDAR_HITTESTINFO
{
public:
...
// {1FED5027-B4A5-492f-ADA0-56E1B0772A53}
static const GUID IID_ICalendarView =
{ 0x1fed5027, 0xb4a5, 0x492f, { 0xad, 0xa0, 0x56, 0xe1, 0xb0, 0x77, 0x2a, 0x53 } };


BEGIN_INTERFACE_MAP(CXTPCalendarView, CXTPCalendarWMHandler)
	INTERFACE_PART(CXTPCalendarView, IID_ICalendarView, Dispatch)
	//INTERFACE_PART(CXTPCalendarView, IID_IEnumVARIANT, EnumVARIANT)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPCalendarView, IID_ICalendarView)
...
{
	CXTPCalendarViewEvent* pViewEvent = DYNAMIC_DOWNCAST(CXTPCalendarViewEvent, CXTPCalendarViewEvent::FromIDispatch(pViewEventDisp));
	if (!pViewEvent)
	{
...
BEGIN_DISPATCH_MAP(CXTPCalendarHitTestInfo, CCmdTarget)
...
// {AFED5027-B4A5-492f-ADA0-56E1B0772A53}
static const GUID IID_ICalendarHitTestInfo =
{ 0xafed5027, 0xb4a5, 0x492f, { 0xad, 0xa0, 0x56, 0xe1, 0xb0, 0x77, 0x2a, 0x53 } };


BEGIN_INTERFACE_MAP(CXTPCalendarHitTestInfo, CCmdTarget)
	INTERFACE_PART(CXTPCalendarHitTestInfo, IID_ICalendarHitTestInfo, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPCalendarHitTestInfo, IID_ICalendarHitTestInfo)
