...
BEGIN_DISPATCH_MAP(CXTPCalendarEvents, CCmdTarget)
...
// {11ED5027-B4A5-492f-ADA0-56E1B0772A53}
static const GUID IID_ICalendarEvents =
{ 0x11ed5027, 0xb4a5, 0x492f, { 0xad, 0xa0, 0x56, 0xe1, 0xb0, 0x77, 0x2a, 0x53 } };


BEGIN_INTERFACE_MAP(CXTPCalendarEvents, CCmdTarget)
	INTERFACE_PART(CXTPCalendarEvents, IID_ICalendarEvents, Dispatch)
	//INTERFACE_PART(CXTPCalendarEvents, IID_IEnumVARIANT, EnumVARIANT)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPCalendarEvents, IID_ICalendarEvents)
...
{
	CXTPCalendarEvent* pEvent = DYNAMIC_DOWNCAST(CXTPCalendarEvent, CXTPCalendarEvent::FromIDispatch(pEventDisp));
	if (!pEvent)
	{
