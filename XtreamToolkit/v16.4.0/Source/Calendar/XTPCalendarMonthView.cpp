...
void CXTPCalendarMonthView::_CalculateEventCaptionFormat(CDC* pDC)
{
	...
	if (!bShowAsClocks)
	{
		...
		m_nEventTimeWidth = min(m_nEventTimeWidth, max(0, nCellWidth - 5));
	}
...
// {4FED5027-B4A5-492f-ADA0-56E1B0772A53}
static const GUID IID_ICalendarMonthView =
{ 0x4fed5027, 0xb4a5, 0x492f, { 0xad, 0xa0, 0x56, 0xe1, 0xb0, 0x77, 0x2a, 0x53 } };


BEGIN_INTERFACE_MAP(CXTPCalendarMonthView, CXTPCalendarView)
	INTERFACE_PART(CXTPCalendarMonthView, IID_ICalendarMonthView, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPCalendarMonthView, IID_ICalendarMonthView)
