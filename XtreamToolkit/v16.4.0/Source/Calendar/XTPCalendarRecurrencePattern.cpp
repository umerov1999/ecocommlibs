...
class _XTP_EXT_CLASS CXTPCalendarRecurrencePatternOptions : public CCmdTarget
{
public:
...
BEGIN_DISPATCH_MAP(CXTPCalendarRecurrencePatternOptions, CCmdTarget)
...
// {13ED5027-B4A5-492f-ADA0-56E1B0772A53}
static const GUID IID_ICalendarRecurrencePatternOptions =
{ 0x13ed5027, 0xb4a5, 0x492f, { 0xad, 0xa0, 0x56, 0xe1, 0xb0, 0x77, 0x2a, 0x53 } };


BEGIN_INTERFACE_MAP(CXTPCalendarRecurrencePatternOptions, CCmdTarget)
	INTERFACE_PART(CXTPCalendarRecurrencePatternOptions, IID_ICalendarRecurrencePatternOptions, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPCalendarRecurrencePatternOptions, IID_ICalendarRecurrencePatternOptions)



BEGIN_DISPATCH_MAP(CXTPCalendarRecurrencePattern, CCmdTarget)
...
// {12ED5027-B4A5-492f-ADA0-56E1B0772A53}
static const GUID IID_ICalendarRecurrencePattern =
{ 0x12ed5027, 0xb4a5, 0x492f, { 0xad, 0xa0, 0x56, 0xe1, 0xb0, 0x77, 0x2a, 0x53 } };


BEGIN_INTERFACE_MAP(CXTPCalendarRecurrencePattern, CCmdTarget)
	INTERFACE_PART(CXTPCalendarRecurrencePattern, IID_ICalendarRecurrencePattern, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPCalendarRecurrencePattern, IID_ICalendarRecurrencePattern)
...
{
	CXTPCalendarEvent* pExc = DYNAMIC_DOWNCAST(CXTPCalendarEvent, CXTPCalendarEvent::FromIDispatch(pExcEventDisp));
	if (!pExc)
	{
