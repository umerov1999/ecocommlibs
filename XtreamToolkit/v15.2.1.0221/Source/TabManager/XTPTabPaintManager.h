...
// Remarks:
//     The enumerators are used by CXTPTabPaintManagerAppearanceSet::DrawWorkspacePart
//     when redrawing the MDITabClient TabWorkspace when grouping is enabled.
// See Also: CXTPTabPaintManagerAppearanceSet::DrawWorkspacePart
//
...
public:
	...
	//     The bounding rectangle can be retrieved with the CXTPTabPaintManagerAppearanceSet::GetHeaderRect,
	//     and CXTPTabManager::GetHeaderRect members.
	// See Also: CXTPTabPaintManagerAppearanceSet::GetHeaderRect, CXTPTabManager::GetHeaderRect
	//-----------------------------------------------------------------------
	...
	//     CXTPTabPaintManagerAppearanceSet::GetClientRect,
...
//-------------------------------------------------------------------------
// Summary:
//     CXTPTabPaintManagerAppearanceSet is a class that represents the appearance of all the
//     components (tab button, tab caption font, button size, tab margins, etc)
//     of the tab manager.
// Remarks:
//     CXTPTabPaintManagerAppearanceSet is the base class for all appearances.  To create a custom
...
//     CXTPTabPaintManagerAppearanceSet object.
...
//-------------------------------------------------------------------------
class _XTP_EXT_CLASS CXTPTabPaintManagerAppearanceSet
{
public:

	//-------------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPTabPaintManagerAppearanceSet object.
	//-------------------------------------------------------------------------
	CXTPTabPaintManagerAppearanceSet();

	//-------------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPTabPaintManagerAppearanceSet object, handles cleanup and deallocation.
	//-------------------------------------------------------------------------
	virtual ~CXTPTabPaintManagerAppearanceSet();
...
public:
	...
	//     icon size to the size of CXTPTabPaintManager.CXTPTabPaintManagerAppearanceSet.m_nButtonHeight,
	//     which is the current height of the tabs without margins and icon size.
	// See Also: CXTPTabPaintManager.CXTPTabPaintManagerAppearanceSet.m_nButtonHeight, CXTPTabPaintManager::m_rcButtonMargin, GetClientMargin, GetHeaderMargin, CXTPTabPaintManager::DrawSingleButtonIconAndText, CXTPTabManager::GetItemMetrics, GetButtonLength
	//-----------------------------------------------------------------------
...
public:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     CColorSetDefault is a CXTPTabPaintManagerColorSet derived class that represents the
	...
	//-------------------------------------------------------------------------
	class _XTP_EXT_CLASS CColorSetDefault : public CXTPTabPaintManagerColorSet
	{
	public:
...
//}}AFX_CODEJOCK_PRIVATE
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     CAppearanceSetPropertyPage is a CXTPTabPaintManagerAppearanceSet derived class that represents the
	...
	//           SetColor, GetColor, GetColorSet, SetColorSet, SetAppearanceSet
	//-------------------------------------------------------------------------
	class _XTP_EXT_CLASS CAppearanceSetPropertyPage : public CXTPTabPaintManagerAppearanceSet
	{
	public:
		...
		// See Also:
		//     CXTPTabPaintManager::SetFontIndirect, CXTPTabPaintManagerAppearanceSet::GetHeaderMargin,
		//     CXTPTabPaintManagerAppearanceSet::GetHeaderMargin::GetClientMargin,
		//     CXTPTabPaintManagerAppearanceSet::GetHeaderMargin::GetButtonLength,
		//     CXTPTabPaintManagerAppearanceSet::GetHeaderMargin::GetButtonHeight
		//-------------------------------------------------------------------------
		virtual void RefreshMetrics();
		...
		//     CXTPTabPaintManager::m_bFillBackground is only FALSE when drawing
		//     DockingPanePanel AutoHide tabs because there is no client area to draw.
		// See Also: CXTPTabPaintManagerAppearanceSet::GetHeaderRect, CXTPTabPaintManager::m_bFillBackground, XTPTabClientFrame, CXTPTabPaintManager::m_clientFrame
		//-----------------------------------------------------------------------
		virtual CRect FillTabControl(CXTPTabManager* pTabManager, CDC* pDC, CRect rcControl);
		...
		// m_wndTabControl.GetPaintManager()->m_rcClientMargin.SetRect(10, 10, 10, 10);
		// </code>
		// See Also: CXTPTabPaintManager::m_rcClientMargin, CXTPTabPaintManagerAppearanceSet::GetHeaderMargin,
		//-----------------------------------------------------------------------
		virtual CRect GetClientMargin();
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     CAppearanceSetPropertyPage2003 is a CXTPTabPaintManagerAppearanceSet derived
	...
	//           SetColor, GetColor, GetColorSet, SetColorSet, SetAppearanceSet
	//-------------------------------------------------------------------------
	class _XTP_EXT_CLASS CAppearanceSetPropertyPage2003 : public CXTPTabPaintManagerAppearanceSet
	{
	public:
		...
		// Remarks:
		//     The CRect structure will contain the margins of the tab header.
		//     CXTPTabPaintManagerAppearanceSet::m_rcHeaderMargin contains
		//     these margins.
		//
		// See Also: CXTPTabPaintManagerAppearanceSet::m_rcHeaderMargin, CXTPTabPaintManager::GetHeaderRect
		//-----------------------------------------------------------------------
		virtual CRect GetHeaderMargin()
		{
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     CAppearanceSetPropertyPage2007 is a CXTPTabPaintManagerAppearanceSet derived
	...
	//           SetColor, GetColor, GetColorSet, SetColorSet, SetAppearanceSet
	//-------------------------------------------------------------------------
	class _XTP_EXT_CLASS CAppearanceSetPropertyPage2007 : public CXTPTabPaintManagerAppearanceSet
	{
	public:
...
//}}AFX_CODEJOCK_PRIVATE
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     CAppearanceSetPropertyPageAccess2007 is a CXTPTabPaintManagerAppearanceSet derived
	//     class that represents the Office 2007 tab appearance.
	// Remarks:
	//     To use the Office 2007 appearance, SetAppearance is used to apply
	//     the xtpTabAppearancePropertyPage2007 XTPTabAppearanceStyle.
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     CAppearanceSetStateButtons is a CXTPTabPaintManagerAppearanceSet derived
	...
	//           SetColor, GetColor, GetColorSet, SetColorSet, SetAppearanceSet
	//-------------------------------------------------------------------------
	class _XTP_EXT_CLASS CAppearanceSetStateButtons : public CXTPTabPaintManagerAppearanceSet
	{
	public:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     CAppearanceSetVisualStudio is a CXTPTabPaintManagerAppearanceSet derived
	...
	//           SetColor, GetColor, GetColorSet, SetColorSet, SetAppearanceSet
	//-------------------------------------------------------------------------
	class _XTP_EXT_CLASS CAppearanceSetVisualStudio : public CXTPTabPaintManagerAppearanceSet
	{
	public:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     CAppearanceSetFlat is a CXTPTabPaintManagerAppearanceSet derived
	...
	//           SetColor, GetColor, GetColorSet, SetColorSet, SetAppearanceSet
	//-------------------------------------------------------------------------
	class _XTP_EXT_CLASS CAppearanceSetFlat : public CXTPTabPaintManagerAppearanceSet
	{
	public:
	...
	class _XTP_EXT_CLASS CAppearanceSetVisualStudio2010 : public CAppearanceSetPropertyPageFlat
	{
	public:

		//-------------------------------------------------------------------------
		// Summary:
		//     Constructs a CAppearanceSetVisualStudio2010 object.
		// Remarks:
		//     By default, m_bBlurPoints is TRUE.  This will smooth the edges
		//     of the tabs.
		//-------------------------------------------------------------------------
		CAppearanceSetVisualStudio2010()
		{
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     CAppearanceSetVisio is a CXTPTabPaintManagerAppearanceSet derived
	...
	//           SetColor, GetColor, GetColorSet, SetColorSet, SetAppearanceSet
	//-------------------------------------------------------------------------
	class _XTP_EXT_CLASS CAppearanceSetVisio : public CXTPTabPaintManagerAppearanceSet
	{
	public:
		...
		// Returns:
		//     Bounding rectangle of tab header area.
		// See Also: GetClientRect, CXTPTabManager::GetControlRect, CXTPTabManager::CXTPTabPaintManagerAppearanceSet::GetHeaderMargin, CXTPTabManager::CXTPTabPaintManagerAppearanceSet::GetClientMargin
		//-----------------------------------------------------------------------
...
public:
	...
	//     This member is called in various Draw and Paint functions.
	//
	//     This member will call CXTPTabPaintManagerAppearanceSet::DrawTabControl
	//     for the currently set appearance. CXTPTabPaintManagerAppearanceSet::DrawTabControl
	...
	//     frame.
	//
	//     Then CXTPTabPaintManagerAppearanceSet::AdjustClientRect is called
	//     if there is one or more tabs in the tab manager.
	// See Also:
	//     CXTPTabPaintManagerAppearanceSet::AdjustClientRect
	//-----------------------------------------------------------------------
	virtual void AdjustClientRect(CXTPTabManager* pTabManager, CRect& rcClient);
	...
	//     used when drawing the tab control.
	//
	//     CXTPTabPaintManagerAppearanceSet::RepositionTabControl is then
	...
	//
	//          CXTPTabPaintManagerAppearanceSet::DrawSingleButton calls
	//          CXTPTabPaintManager::DrawSingleButtonIconAndText
	//          after the button is drawn.  This is called to draw the button's
	//          icon and text.
	//
	// See Also: CXTPTabPaintManager::DrawTabControlEx, CXTPTabPaintManagerAppearanceSet::DrawSingleButton
	//-----------------------------------------------------------------------
	...
	//     currently used CXTPTabPaintManagerColorSet and CXTPTabPaintManagerAppearanceSet.
	//-------------------------------------------------------------------------
	virtual void RefreshMetrics();
...
protected:
	...
	//     rcControl   - Bounding rectangle of the client area.
	// Remarks:
	//     DrawTabControl calls CXTPTabPaintManagerAppearanceSet::DrawTabControl
	//     which will then call DrawTabControlEx if it has not been overridden.
	// See Also:
	//     CXTPTabPaintManagerAppearanceSet::DrawTabControl
	//-----------------------------------------------------------------------
	...
	//     rcClient    - Client rectangle of control
	// Remarks:
	//     RepositionTabControl calls CXTPTabPaintManagerAppearanceSet::RepositionTabControl
	...
	//     used when drawing the tab control.
	// See Also:
	//     CXTPTabPaintManagerAppearanceSet::RepositionTabControl
	//-----------------------------------------------------------------------
...
protected:
	CXTPTabPaintManagerAppearanceSet*   m_pAppearanceSet;             // Currently set CXTPTabPaintManagerAppearanceSet.
...
private:
	...
	friend class CXTPTabPaintManagerAppearanceSet;
...
AFX_INLINE CRect CXTPTabPaintManagerAppearanceSet::GetHeaderMargin() {
	return m_rcHeaderMargin;
}
AFX_INLINE CRect CXTPTabPaintManagerAppearanceSet::FillTabControl(CXTPTabManager* /*pTabManager*/, CDC* /*pDC*/, CRect /*rcControl*/) {
	return CRect(0, 0, 0, 0);
}
AFX_INLINE void CXTPTabPaintManagerAppearanceSet::DrawSingleButton(CDC* /*pDC*/, CXTPTabManagerItem* /*pItem*/) {

}
AFX_INLINE void CXTPTabPaintManagerAppearanceSet::DrawTabControl(CXTPTabManager* pTabManager, CDC* pDC, CRect rcControl) {
	m_pPaintManager->DrawTabControlEx(pTabManager, pDC, rcControl);
}
AFX_INLINE void CXTPTabPaintManagerAppearanceSet::RepositionTabControl(CXTPTabManager* pTabManager, CDC* pDC, CRect rcClient) {
...
AFX_INLINE CXTPTabPaintManagerAppearanceSet* CXTPTabPaintManager::GetAppearanceSet() const {
...
AFX_INLINE CXTPTabPaintManagerColorSet* CXTPTabPaintManagerAppearanceSet::GetColorSet() const {
