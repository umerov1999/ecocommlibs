...
#include "XTPTaskPanelAnimation.h"
...
void CXTPTaskPanel::SetTheme(XTPTaskPanelPaintTheme paintTheme)
{
	...
	else if (paintTheme == xtpTaskPanelThemeShortcutBarOffice2007) m_pPaintManager = new CXTPTaskPanelShortcutBarOffice2007Theme();
	else if (paintTheme == xtpTaskPanelThemeVisualStudio2010) m_pPaintManager = new CXTPTaskPanelVisualStudio2010Theme();
