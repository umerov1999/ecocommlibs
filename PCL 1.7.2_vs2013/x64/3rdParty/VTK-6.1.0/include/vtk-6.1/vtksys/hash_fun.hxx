...
#include <vtksys/stl/string>     // string
...
vtksys_CXX_DEFINE_SPECIALIZATION
struct hash<char*> {
...
vtksys_CXX_DEFINE_SPECIALIZATION
  struct hash<vtksys_stl::string> {
  size_t operator()(const vtksys_stl::string & __s) const { return _stl_hash_string(__s.c_str()); }
};

#if !defined(__BORLANDC__)
vtksys_CXX_DEFINE_SPECIALIZATION
  struct hash<const vtksys_stl::string> {
  size_t operator()(const vtksys_stl::string & __s) const { return _stl_hash_string(__s.c_str()); }
};
#endif
